...
import com.philippo.algafood.api.V1.assembler.ProductInputDisassembler;
import com.philippo.algafood.api.V1.assembler.ProductModelAssembler;
import com.philippo.algafood.api.V1.model.ProductModel;
import com.philippo.algafood.api.V1.model.input.ProductInput;
import com.philippo.algafood.api.V1.openapi.controller.RestaurantProductControllerOpenApi;
...
@RestController
@RequestMapping(value = "/v1/restaurants/{restaurantId}/products", produces = MediaType.APPLICATION_JSON_VALUE)
