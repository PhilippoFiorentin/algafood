...
public class JdbcOAuth2AuthorizationQueryService implements OAuth2AuthorizationQueryService {
    ...
    private final RowMapper<OAuth2Authorization> oAuth2AuthorizationRowManager;

    private final String LIST_AUTHORIZED_CLIENTS = "select rc.* from oauth2_authorization_consent c " +
            "inner join oauth2_registered_client rc on rc.id = c.registered_client_id where c.principal_name = ?";
    ...
    public JdbcOAuth2AuthorizationQueryService(JdbcOperations jdbcOperations, RegisteredClientRepository repository) {
        ...
        this.oAuth2AuthorizationRowManager = new JdbcOAuth2AuthorizationService.OAuth2AuthorizationRowMapper(repository);
    }
    ...
    public List<OAuth2Authorization> listAuthorizations(String principalName, String clientId) {
        return this.jdbcOperations.query(LIST_AUTHORIZATIONS, oAuth2AuthorizationRowManager, principalName, clientId);
    }
}
